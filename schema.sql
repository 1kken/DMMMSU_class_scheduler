...
CREATE TABLE `schedule` (
  ...
  CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`room_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `schedule_ibfk_5` FOREIGN KEY (`student_record_id`) REFERENCES `student_record` (`student_record_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
