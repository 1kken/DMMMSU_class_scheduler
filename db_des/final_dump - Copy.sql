...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER `insert_unit_counter_trigger` AFTER INSERT ON `schedule` 
    FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER `insert_unit_counter_trigger_update` AFTER UPDATE ON `schedule` 
    FOR EACH ROW BEGIN
    DECLARE time_counter INT;
...
-- Dump completed on 2024-05-14 18:49:46
