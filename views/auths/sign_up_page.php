            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 max-w-xl">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" id="email" class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="name@company.com" required="">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="confirm-password" name="confirm-password" id="confirm-password" placeholder="••••••••" class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required="">
                    </div>
